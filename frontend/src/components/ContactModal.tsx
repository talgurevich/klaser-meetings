      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-end gap-8 pt-1">
          ...
          <label
            ...
            title={
              systemUser
                ? "חבר ועד לפי התאמת אימייל — מוזמן אוטומטית לכל פגישה"
                : "חבר ועד — מוזמן אוטומטית לכל פגישה"
            }
          >
            <span className="text-ink-soft">
              חבר ועד{" "}
              {systemUser && <span className="font-rubik text-xs">(לפי אימייל)</span>}
            </span>
            <DsToggle
              checked={systemUser || editorFlag}
              disabled={systemUser}
              onChange={setEditorFlag}
              ariaLabel="חבר ועד"
            />
          </label>
        </div>
